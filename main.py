from api_requests import us_states, us_state_specific
...
def write (data, file_name):
    ...
    for point in data:
        ...
        states[hash_val] = {
            ...
            "riskLevels": point["riskLevels"],
            "actuals":    point["actuals"]
        }
    open(file_name, 'w+').write(dumps(states, indent='\t'))
...
def main():
    ...
    # data = us_states()
    data = us_state_specific(use_ts=False)
    write(data, 'temp.txt')
